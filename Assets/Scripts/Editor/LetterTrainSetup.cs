...
/// <summary>
/// Builds the LetterTrain scene — landscape layout.
/// Purple-themed Hebrew alphabet train.
/// </summary>
public class LetterTrainSetup : EditorWindow
{
    ...
    public static void RunSetupSilent()
    {
        try
        {
            EditorUtility.DisplayProgressBar("Letter Train", "Building scene...", 0.5f);
            BuildScene();
    ...
    private static void BuildScene()
    {
        ...
        HebrewText.SetText(titleTMP, "\u05E8\u05DB\u05D1\u05EA \u05D4\u05D0\u05D5\u05EA\u05D9\u05D5\u05EA"); // רכבת האותיות
        ...
        // Controller
        var ctrl = canvasGO.AddComponent<LetterTrainController>();
    ...
    // Helpers (same pattern as all other setups)

    private static readonly Color RailColor = HexColor("#5D4037");
    private static readonly Color SleeperColor = HexColor("#795548");
