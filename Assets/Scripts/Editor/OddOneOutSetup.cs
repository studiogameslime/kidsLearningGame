...
/// <summary>
/// Builds the OddOneOut scene — landscape layout.
/// Top bar with title, large centered row of 4 animal cards.
/// </summary>
public class OddOneOutSetup : EditorWindow
{
    private static readonly Vector2 Ref = new Vector2(1920, 1080);
    private const int TopBarHeight = 100;

    private static readonly Color BgColor  = HexColor("#F5F0EB");
    private static readonly Color BarColor = HexColor("#FF7043"); // warm orange

    public static void RunSetupSilent()
    {
        try
        {
            EditorUtility.DisplayProgressBar("Odd One Out", "Building scene...", 0.5f);
            BuildScene();
    ...
    private static void BuildScene()
    {
        ...
        HebrewText.SetText(titleTMP, "\u05DE\u05E6\u05D0 \u05D0\u05EA \u05D4\u05E9\u05D5\u05E0\u05D4"); // מצא את השונה
        ...
        // ── Row area: single horizontal strip, vertically centered, full width ──
        var rowGO = new GameObject("RowArea");
        rowGO.transform.SetParent(playRT, false);
        var rowRT = rowGO.AddComponent<RectTransform>();
        rowRT.anchorMin = new Vector2(0.02f, 0.05f);
        rowRT.anchorMax = new Vector2(0.98f, 0.95f);
        ...
        //  CONTROLLER
        // ══════════════════════════════════════════
        var ctrl = canvasGO.AddComponent<OddOneOutController>();
        ctrl.rowArea = rowRT;
